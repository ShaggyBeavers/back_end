...
public class AdminController {
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN', 'REGIONAL_MODERATOR') and @securityFacade.checkIfUserHasEnoughAuthorityOnUser(authentication, #dto.moderatorId)")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN', 'REGIONAL_MODERATOR') and @securityFacade.checkIfUserHasEnoughAuthorityOnUser(authentication, #moderatorId)")
